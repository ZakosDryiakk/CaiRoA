sprite_change_offset("idle", 52, 92);
sprite_change_offset("hurt", 32, 62);
sprite_change_offset("crouch", 52, 96);
sprite_change_offset("walk", 58, 102);
sprite_change_offset("walkturn", 32, 62);
sprite_change_offset("dash", 82, 92);
sprite_change_offset("dashstart", 68, 102);
sprite_change_offset("dashstop", 32, 62);
sprite_change_offset("dashturn", 82, 102);

sprite_change_offset("jumpstart", 62, 102);
sprite_change_offset("jump", 52, 86);
sprite_change_offset("doublejump", 32, 62);
sprite_change_offset("walljump", 32, 62);
sprite_change_offset("pratfall", 32, 62);
sprite_change_offset("land", 52, 92);
sprite_change_offset("landinglag", 52, 92);
...
sprite_change_offset("ftilt", 54, 94);
...
sprite_change_offset("dair", 54, 84);
sprite_change_offset("fstrong", 54, 94);
